...
fig = plt.figure(dpi=250, figsize=(2,2))
...
nx.draw_networkx_edges(G=lattice, pos=pos, width=0.5)
nx.draw_networkx_nodes(G=lattice, pos=pos, node_size=25,
                       node_color="k")

out_dir = "/home/thosvarley/Website/thosvarley.github.io/assets/images"
plt.savefig("lattice_big.jpg", bbox_inches="tight",
            transparent=True)